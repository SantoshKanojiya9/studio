...
export const RslimeFace = ({ 
  ...
  const eyeVariants = {
    neutral: { d: "M 20 40 C 35 35, 65 35, 80 40" },
    happy: { d: "M 20 45 C 35 30, 65 30, 80 45" },
    angry: { d: "M 20 35 C 35 45, 65 45, 80 35" },
    sad: { d: "M 20 40 C 35 50, 65 50, 80 40" },
    surprised: { d: "M 20 35 C 35 25, 65 25, 80 35" },
    scared: { d: "M 20 30 C 40 45, 60 45, 80 30" },
    love: { d: "M 20 45 C 35 30, 65 30, 80 45" },
  };
