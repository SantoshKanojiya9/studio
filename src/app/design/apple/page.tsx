...
const Face = ({ 
  ...
  return (
    ...
    >
      ...
      >
        <motion.div 
          className="w-full h-full shadow-[inset_0_-20px_30px_rgba(0,0,0,0.2),_0_10px_20px_rgba(0,0,0,0.3)] relative overflow-hidden" 
          animate={{ backgroundColor: color }}
          transition={{ duration: 0.3 }}
          style={{ clipPath: `path('M159.4,244.3c-7.1,0-14.3-0.9-21.3-2.6c-31.1-7.7-56-29.8-71-55.8c-1-1.7-2-3.5-2.9-5.3c-28.3-53.8-11.3-121.5,42.5-150.1C133-1.2,166.4-5.3,195.8,12c28.3,16.7,47.3,47,51.8,80.7c0.8,5.7,1,11.5,0.7,17.2c-1.3,25.9-10.8,50.1-26.6,68.9c-12.8,15.3-28.5,27.3-46.2,35.1C169.8,243.6,164.6,244.3,159.4,244.3z')` }}
        >
            <div className="w-full h-full bg-gradient-to-br from-white/30 to-transparent flex items-center justify-center relative">
...
export default function DesignPage() {
  ...
  const [emojiColor, setEmojiColor] = useState('#ff4136'); // Apple Red
  ...
  const defaultEmojiColor = '#ff4136'; // Apple Red
