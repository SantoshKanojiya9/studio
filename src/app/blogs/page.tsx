          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <article className="bg-card p-6 sm:p-8 rounded-lg shadow-lg">
              ...
              <div className="space-y-6 text-muted-foreground text-base sm:text-lg">
                  ...
                  <p>Still I told myself if I don’t share, I will never know. So on that same day, I also created the legal pages – Privacy Policy, Terms etc. And just below them I add one simple line: “For any issues contact me at contact@edengram.com”. So at least I know if people like my website or not.</p>
