        ...
        <main className="container mx-auto py-12 px-4 md:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-muted-foreground">
              ...
              <p>
                Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the Edengram application and reading our blog (the "Service") operated by us.
              </p>

              <h3 className="text-2xl font-semibold text-foreground pt-4">1. Accounts</h3>
              <p>
                When you create an account with us, you must provide us information that is accurate, complete, and current at all times. You are responsible for safeguarding the password that you use to access the Service and for any activities or actions under your password. Failure to comply with these terms constitutes a breach, which may result in immediate termination of your account on our Service.
              </p>

              <h3 className="text-2xl font-semibold text-foreground pt-4">2. User-Generated Content</h3>
              <p>
                Our Service allows you to post, link, store, share and otherwise make available certain information, text, graphics, or other material ("Content"). You are responsible for the Content that you post to the Service, including its legality, reliability, and appropriateness. You retain any and all of your rights to any Content you submit, post or display on or through the Service.
              </p>
              ...
              <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>To engage in any conduct that is harmful, fraudulent, deceptive, threatening, harassing, defamatory, obscene, or otherwise objectionable.</li>
                  <li>For the purpose of exploiting, harming, or attempting to exploit or harm minors in any way.</li>
                  <li>To transmit, or procure the sending of, any advertising or promotional material, including any "junk mail", "chain letter," "spam," or any other similar solicitation.</li>
              </ul>
               
              <h3 className="text-2xl font-semibold text-foreground pt-4">4. Blog Content</h3>
               <p>
                  The content on our blog is for informational purposes only. While we strive for accuracy, we make no guarantees about the completeness, reliability, or accuracy of this information. Any action you take upon the information on our blog is strictly at your own risk.
              </p>

              <h3 className="text-2xl font-semibold text-foreground pt-4">5. Termination</h3>
              <p>
                We may terminate or suspend your account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach the Terms.
              </p>

              <h3 className="text-2xl font-semibold text-foreground pt-4">6. Governing Law</h3>
              <p>
